...
Simple Intelligent Indexing installation:
...
The installation directory contains the Intelligent Indexing connection file at `\setup\run\intelligent-indexing-connection.xml`, which DocuWare uses to establish the connection to Intelligent Indexing. This file is generated by the setup.

This file contains the connection URL. In case your server is reached with a different name than the machine name, or you configured the IIS to use `https`, you should change this URL in this file.
